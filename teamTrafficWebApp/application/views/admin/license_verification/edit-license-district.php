        ...
        <div class="col-xs-12">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Update License Verification District</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                  ...
                  <div class="box-body">
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" name="name" required id="name" value="<?php echo $record['name']; ?>" placeholder="Enter Name Here">
                      </div>
                    </div>
