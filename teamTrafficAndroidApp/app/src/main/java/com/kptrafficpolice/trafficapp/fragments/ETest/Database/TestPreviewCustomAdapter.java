...
public class TestPreviewCustomAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.ques_num = (TextView) vi.findViewById(R.id.num);

            holder.ques = (TextView) vi.findViewById(R.id.ques);
            holder.op1  = (TextView) vi.findViewById(R.id.op1);
            holder.op2  = (TextView) vi.findViewById(R.id.op2);
            holder.op3  = (TextView) vi.findViewById(R.id.op3);
            holder.op1_img  = (ImageView) vi.findViewById(R.id.imageView1);
            holder.op2_img  = (ImageView) vi.findViewById(R.id.imageView2);
            holder.op3_img  = (ImageView) vi.findViewById(R.id.imageView3);
            holder.img     = (ImageView) vi.findViewById(R.id.img);

            holder.relative_layout1 = (RelativeLayout) vi.findViewById(R.id.relative_layout1);
            holder.relative_layout2 = (RelativeLayout) vi.findViewById(R.id.relative_layout2);
            holder.relative_layout3 = (RelativeLayout) vi.findViewById(R.id.relative_layout3);
