...
public class LiveUpdateResultFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        locations.add(new LatLng(34.032627, 71.576201));
        locations.add(new LatLng(34.034312, 71.5779767));
        locations.add(new LatLng(34.046545, 71.5806858));
        locations.add(new LatLng(34.05858, 71.5868058));
