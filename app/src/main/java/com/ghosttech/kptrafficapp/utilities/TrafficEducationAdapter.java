...
public class TrafficEducationAdapter extends RecyclerView.Adapter<TrafficEducationAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView imageTitle;
        ImageView TrafficEducationImage;
        ...
        public ViewHolder(View v) {
            ...
            TrafficEducationImage = (ImageView)itemView.findViewById(R.id.traffic_education_image);
        }
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        TrafficEducationHelper current = data.get(position);

        holder.imageTitle.setText(current.strImageTitle);
        holder.descriptionEnglish.setText(current.strDescriptionEnglish);
        holder.descriptionUrdu.setText(current.strDescriptionUrdu);
        // holder.TrafficEducationImage.setImageResource(Integer.parseInt(current.strImage));
        Picasso.with(context).load("http://103.240.220.76/kptraffic/uploads/traffic-education/"+current.strImage).into(holder.TrafficEducationImage);
    }
